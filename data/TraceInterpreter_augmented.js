...
var BNTColor = S$.symbol('BNTColor',"#556270");


var EFColor = S$.symbol('EFColor',"#E97F02");


var IFColor = S$.symbol('IFColor',"#948C75");


var fs = S$.symbol('fs',[true, "1234", "random"]);


var generateGraphs = S$.symbol('generateGraphs',true);
